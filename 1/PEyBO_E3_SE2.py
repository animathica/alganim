...
class Escena4(ThreeDScene):
    ...
    def Signo(self):
        ...
        self.wait()
        self.play(VT_A_2.animate.set_value(-2),run_time=3)
        ...
        self.play(VT_A_2.animate.set_value(5),run_time=3)
        ...
        self.play(VT_B_2.animate.set_value(-2),run_time=3)
        self.play(VT_B_2.animate.set_value(1),run_time=2)
        self.play(Create(Rayo_extremo_2_2))
        self.play(VT_B_2.animate.set_value(4),run_time=3)
