...
class SE1(MovingCameraScene):
    ...
    #-------------------------------------------------------Propiedades del producto escalar en un campo K
     def propiedades(self):
         ...
         t7 = Tex("Simetría conjugada").scale(.55)
         ...
         b1.next_to(p2_2, RIGHT*UP).shift(1.5*RIGHT+.4*DOWN)
         self.play(Write(b1))
         self.wait(0.5)
         ...
         self.wait(11.5)
         self.play(FadeOut(t2, t3, t4, t5, t6, t7, b1, b2))
         self.wait(9.5)
...
class SE2(MovingCameraScene):
     ...
     def ortogonalidad(self):
       ...
       gamma_Prop = VGroup(o5, gj_gi).arrange(direction=RIGHT, buff=0.75, center=True).shift(0.25*DOWN)
       ...
       self.wait(4)
       o3.move_to(UP)
       self.play(Write(o3[0][0:36]), run_time=3)
