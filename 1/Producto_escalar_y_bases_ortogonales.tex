...
\end{align*}
\noindent Veamos que la operación que define efectivamente cumple las propiedades de producto escalar, demostrándolas una por una\footnote{Agregar nota al pie que diga a qué tiempo del video termina la demostración.}. \\
...
\subsection*{SE2} % Base ortogonal y resolución del problema de encontrar coeficientes
