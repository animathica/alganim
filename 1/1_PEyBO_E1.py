...
class Subescena_2(Scene):
    ...
    def parte_2(self):
        ...
        Text14_3 = Tex('''$ \\{ c_1 \\vec{b}_1 + c_2 \\vec{b}_2 : c_1, c_2 \\in \\mathbb{R} \\} = \\mathbb{R}^2 $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text14_3[0][1:12].set_color(MAGENTA_CLARO)
        Text14_3[0][-2:None].set_color(MAGENTA_CLARO)
        ...
        def gen1(Vec1,Vec2,Lab1,Lab2):
            ...
            self.play(Create(Num_Lin_1),Write(ParSup1),Write(ParInf1),Write(Inf_1),Write(MInf_1),Create(LINEA_1),Create(FLECHA_1),Create(Coef_1),Write(Text14.group))
            ...
            self.play(Create(Num_Lin_2),Write(ParSup2),Write(ParInf2),Write(Inf_2),Write(MInf_2),Create(LINEA_2),Create(FLECHA_2),Create(Coef_2),ReplacementTransform(Text14.group,Text14_2.group))
...
class Subescena_3(Scene):
    def parte_3(self):
        ...
        base_beta_dimK_8 = MathTex("\\mathcal{K}^k")
        ...
        base_beta_dimK1_10 = MathTex("\\mathcal{K}^{k+1}")
        ...
        base_beta_dimK2_12 = MathTex("\\mathcal{K}^{k+2}")
