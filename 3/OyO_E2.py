...
class SE1(ThreeDScene):

    def parte1(self, a, b, c):
                text1 = TexMobject(r"I = \qty\big{\vec{a}, \vec{b}, \vec{c} \ }").move_to(3*DOWN+5*LEFT)
                ...
                text2 = TexMobject(r'''\Gamma_1 = \qty\big{ \vec{a}, \vec{b} ', \vec{c} \hspace{0.1cm} '  } ''').move_to(3*DOWN+5*RIGHT)
                ...
                text5 = TexMobject(r" \langle \ \Gamma_1 \ \rangle", r" = ", r"\langle \ I \ \rangle \ ").move_to(DOWN-5*RIGHT)
                text5[0].set_color(TEAL_A)
                text5[2].set_color(MAGENTA)
                ...
                c_vec_label = TexMobject(r"\vec{c}").move_to(-0.7*RIGHT+1.5*UP)
                ...
                c_vec_pro_label=TexMobject(r"-", r" \frac{\langle \ \vec{c}, \vec{a} \ \rangle}{||\vec{a}||}\hat{a} ").move_to(-0.2*RIGHT+1.85*UP).scale(0.7)
                c_vec_pro_label[0].set_color(BLACK)  
                c_vec_pro_labelc=TexMobject(r" -  ").move_to(1.75*LEFT+1.1*DOWN).scale(0.7)
                ...
                b_vec_pro_label=TexMobject(r"-", r" \frac{\langle \ \vec{c}, \vec{b'} \ \rangle}{||\vec{b'}||}\hat{b'} ").move_to(1*RIGHT+0.4*DOWN).scale(0.7)
                b_vec_pro_label[0].set_color(BLACK)  
                b_vec_pro_labelc=TexMobject(r" -  ").move_to(3.3*LEFT+0.1*DOWN).scale(0.7)
                ...
                self.play(Write(a_vec_label), run_time = 0.5)
                ...
                self.play(Write(b_vec_label), run_time = 0.5)
                self.play(GrowArrow(c_vec))
                self.add_fixed_in_frame_mobjects(c_vec_label)
                self.play(Write(c_vec_label), run_time = 0.5)
                self.add_foreground_mobjects(c_vec, text1_bg, text1)
                self.add_fixed_in_frame_mobjects(text1_bg)
                self.add_fixed_in_frame_mobjects(text1)
                self.play(Write(text1_bg), Write(text1))
                self.play(Write(a_li), run_time=0.5)
                self.play(Write(b_li), run_time=0.5)
                self.play(Write(c_li), run_time=0.5)
                ...
                self.move_camera(phi=30*DEGREES, theta=-20*DEGREES, gamma = 0*DEGREES, run_time=0.5)
                self.subespacios(a,b,c,a_vec,b_vec,c_vec, -21.7, 23.5, 84.5*DEGREES, text3, text3_bg, MAGENTA)
                self.move_camera(phi=90*DEGREES, theta=45*DEGREES, run_time = 0.5)
                ...
                self.play(Write(text2_bg), Write(text2[0][:7]), Write(text2[0][-1].move_to(3*DOWN+5.8*RIGHT)))
                ...
                self.play(Transform(a_vec_pro, suma_a), AnimationGroup(ApplyMethod(a_vec_pro_label.move_to, 2.5*RIGHT+0.5*DOWN), FadeIn(a_vec_pro_labelc), lag_ratio = 0.3), run_time=1.5)
                ...
                self.move_camera(phi=85*DEGREES, theta=40*DEGREES, run_time=2, added_anims= [a_ort_label.move_to, 0.65*RIGHT+1.25*DOWN])
                self.wait()
                self.remove_foreground_mobjects(a_vec_pro_label, a_vec, b_vec_pro_label, b_vec, text2_bg, text2[0][:7], text2[0][-1], text2[0][7:10])
                ...
                self.play(Transform(c_vec_pro, suma_c), AnimationGroup(ApplyMethod(c_vec_pro_label.move_to, 1.1*LEFT+1.1*DOWN), FadeIn(c_vec_pro_labelc), lag_ratio = 0.2), run_time=3)
                ...
                self.wait(3)
                self.play(FadeOut(c_ort), FadeOut(tache))
                self.wait(2)
                ...
                self.play(Transform(b_vec_pro, suma_b), AnimationGroup(ApplyMethod(b_vec_pro_label.move_to, 2.6*LEFT+0.1*DOWN), FadeIn(b_vec_pro_labelc), lag_ratio = 0.2), run_time=3)
                ...
                self.play(Write(text2[0][10:14]),text2[0][-1].move_to, 3*DOWN+6.5*RIGHT)
                self.play(FadeOut(b_vec_pro), FadeOut(b_vec_pro_label), FadeOut(c_vec_pro), FadeOut(c_vec_pro_label), FadeOut(c_vec_pro_labelc), FadeOut(paloma), FadeOut(c_vec_pro), FadeOut(b_vec), FadeOut(b_vec_label), FadeOut(c_vec), FadeOut(c_vec_label), FadeOut(b_vec_pro_labelc))
                self.wait(3)
                
                #SUBESPACIOS
                
                self.play(a_vec_label.set_opacity, 0, a_ort_label.set_opacity, 0, cb_ort_label.set_opacity, 0)
                self.move_camera(phi=80*DEGREES, theta=75*DEGREES, gamma=25*DEGREES, run_time=2)
                self.add_foreground_mobjects(text1_bg, text1)
                self.add_fixed_in_frame_mobjects(text1_bg, text1)
                self.add_foreground_mobjects(text2_bg, text2) #
                self.add_fixed_in_frame_mobjects(text2_bg, text2) #
                ...
                self.play(FadeOut(text1),FadeOut(text1_bg), run_time=0.5)
                self.remove_foreground_mobjects(text2_bg, text2, text2[0][7:10]) #
                self.play(FadeOut(text2),FadeOut(text2_bg), run_time=0.5) #
    ...
    def subespacios(self, a, b, c, a_vec1, b_vec1, c_vec1, anguloz, angulox, cameraphi, text, text_bg, COLOR):
                ...
                self.play(Write(a_vec1_suma), Write(b_vec1_suma), Write(c_vec1_suma), Write(dotb), GrowArrow(suma), run_time=2.5)
                self.wait(0.5)
...
class SE2(ThreeDScene):
    ...
    def projection_of_b_and_c_along_a(self, a, b, c, a_vec, b_vec, c_vec):
                ...
                a_pro = projection_of_a_along_b(b, a)
                a_vec_pro = Vector(direction = a_pro, color = YELLOW, buff=0)
                line_a_perp = DashedLine(b, a_pro, width=5, color = YELLOW, buff=0)
                a_ort = Vector(direction = b-a_pro, color = VERDE, buff=0)
                suma_a = Arrow(start = b, end = b-a_pro, color = YELLOW, buff=0)
                ...
                c_pro = projection_of_a_along_b(c, a)
                c_vec_pro = Vector(direction = c_pro, color = YELLOW, buff=0)
                line_c_perp = DashedLine(c, c_pro, width=5, color = YELLOW, buff=0)
                suma_c = Arrow(start = c, end = c-c_pro, color = YELLOW, buff=0)

                #PROYECCION DE C SOBRE B'
                b_pro = projection_of_a_along_b(c, b-a_pro)
                b_vec_pro = Vector(direction = b_pro, color = YELLOW, buff=0, max_tip_length_to_length_ratio = 0.4)
                line_b_perp = DashedLine(c, b_pro, width=5, color = YELLOW, buff=0)
                suma_b = Arrow(start = c-c_pro, end = c-c_pro-b_pro, color = YELLOW, buff=0, max_tip_length_to_length_ratio = 0.4)
                cb_ort = Vector(direction = c-c_pro-b_pro, color = MAGENTA, buff=0)

                self.play(GrowArrow(a_vec),GrowArrow(b_vec),GrowArrow(c_vec))
                self.wait(2.5) # para los parámetros de Gamma_1, Gamma_2, Gamma_3 y Gamma_4
                self.play(a_vec.set_color, [WHITE, MAROON_A, YELLOW_C], rate_func = there_and_back, run_time = 3 )
                
                #PROYECCION DE B SOBRE A
                self.play(Write(line_a_perp), run_time=0.5)
                self.play(GrowArrow(a_vec_pro))
                self.play( FadeOut(line_a_perp), run_time=0.5)
                self.play(Transform(a_vec_pro, suma_a))
                self.play(GrowArrow(a_ort))
                self.play(FadeOut(a_vec_pro))
                
                #PROYECCION DE C SOBRE A
                self.play(Write(line_c_perp), run_time=0.5)
                self.play(GrowArrow(c_vec_pro))
                self.play( FadeOut(line_c_perp), run_time=0.5)
                self.play(Transform(c_vec_pro, suma_c))
            
                
                #PROYECCION DE C SOBRE B'
                self.play(Write(line_b_perp), run_time=0.5)
                self.play(GrowArrow(b_vec_pro))
                self.play( FadeOut(line_b_perp), run_time=0.5)
                self.play(Transform(b_vec_pro, suma_b))
    ...
    def construct(self):
        ...
        self.play(ShowCreation(axes))
        #self.wait()
        #self.projection_of_b_and_c_along_a(a, b, c, a_vec, b_vec, c_vec)
        self.projection_of_b_and_c_along_a(a, c, b, a_vec, c_vec, b_vec)
        #self.projection_of_b_and_c_along_a(b, a, c, b_vec, a_vec, c_vec) # La última flecha amarilla es diminuta
        #self.projection_of_b_and_c_along_a(b, c, a, b_vec, c_vec, a_vec) # La última flecha amarilla es inperceptible
        #self.projection_of_b_and_c_along_a(c, a, b, c_vec, a_vec, b_vec)
        #self.projection_of_b_and_c_along_a(c, b, a, c_vec, b_vec, a_vec) # La última flecha amarilla no tiene cabeza
...
class SE3(ThreeDScene):
    ...
    def parte2(self, a, b, c):
                ...
                self.wait()
                self.play(GrowArrow(a_vec),GrowArrow(b_vec),GrowArrow(c_vec), run_time=1.5)
                self.wait(5)
                ...
                self.play(Write(line_a_perp), run_time=0.5)
                self.play(GrowArrow(a_vec_pro))
                self.play(FadeOut(line_a), FadeOut(line_a_perp), run_time=0.5)
                ...
                #PROYECCION DE C SOBRE A
                self.play(Write(line_c_perp), run_time=0.3)
                self.play(GrowArrow(c_vec_pro))
                self.play(FadeOut(line_c), FadeOut(line_c_perp), run_time=0.3)
                self.play(Transform(c_vec_pro, suma_c), run_time=1)
            
                
                #PROYECCION DE C SOBRE B'
                self.play(Write(line_b_perp), run_time=0.3)
                self.play(GrowArrow(b_vec_pro))
                self.play(FadeOut(line_b), FadeOut(line_b_perp), run_time=0.3)
                self.play(Transform(b_vec_pro, suma_b), run_time=1)
                self.play(GrowArrow(cb_ort))
                self.play(FadeOut(b_vec_pro), FadeOut(c_vec_pro), FadeOut(b_vec), FadeOut(c_vec))
    ...
    def subespacios(self, a, b, c, a_vec1, b_vec1, c_vec1, anguloz, angulox, cameraphi, text, text_bg, COLOR):
                ...
                self.play(Write(a_vec1_suma), Write(b_vec1_suma), Write(c_vec1_suma), Write(dotb), GrowArrow(suma), run_time=2.5)
                self.wait(0.5)
                self.remove_foreground_mobjects(b_vec1_suma)
                self.play(  UpdateFromFunc(b_vec1,update_b), 
                            UpdateFromFunc(a_vec1_suma,update_a_s),
                            UpdateFromFunc(b_vec1_suma,update_b_s), 
                            UpdateFromFunc(c_vec1_suma,update_c_s),
