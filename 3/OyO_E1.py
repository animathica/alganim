...
class Escena1(ThreeDScene):
    ...
    def construct(self):
        ...
        Cto = TextMobject('''$ I = \\{ \\vec{a}, \\vec{b} \\} $''').move_to(3*DOWN + 3.5*LEFT)
        for i in range(3,5):
        ...
        CtoO = TextMobject('''$ \\Gamma_2 = \\{ \\vec{b} \\} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
        ...
        CtoO_1_1 = TextMobject('''$ \\Gamma_2 = \\{ \\vec{b} \\} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
            CtoO_1_1[0][i].set_color(ROJO)
        CtoO_2 = TextMobject('''$ \\Gamma_2 = \\{ \\vec{b} , \\vec{a}' \\} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
            CtoO_2[0][i].set_color(ROJO)
        for i in range(6,10):
            CtoO_2[0][i].set_color(BLACK)
        CtoO_2_1 = TextMobject('''$ \\Gamma_2 = \\{ \\vec{b} , \\vec{a}' \\} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
        ...
        CtoON = TextMobject(''' $ N = \{ \hat{b} \} $ ''').move_to(3*DOWN + 3.5*RIGHT)
        ...
        CtoON_1 = TextMobject(''' $ N = \{ \hat{b} \} $ ''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(3,5):
            CtoON_1[0][i].set_color(ROJO)
        CtoON_2 = TextMobject(''' $ N = \{ \hat{b},\hat{a}' \} $ ''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(3,5):
        ...
        #Text5_1 = TextMobject('''$ \\frac{ \\langle \\vec{b} , \\vec{a} \\rangle} { \\norm{ \\vec{a}} } \\hat{a} $''').set_color(AMARILLO).move_to(VecP_2.get_end()+0.9*UP)
        #Text5_2 = TextMobject('''$ - \\frac{ \\langle \\vec{b} , \\vec{a} \\rangle} { \\norm{ \\vec{a}} } \\hat{a} $''').set_color(AMARILLO).move_to(VecPC_1.get_end()+0.9*RIGHT)

        # Texto para segundo conjunto ortonormal, su rectángulo, y las variaciones usadas.
        Text6 = TextMobject('''$ \\Gamma_1 = \{ \\vec{a} \} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
        ...
        Text6_1 = TextMobject('''$ \\Gamma_1 = \{ \\vec{a} \} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
            Text6_1[0][i].set_color(AZUL)
        Text6_2 = TextMobject('''$ \\Gamma_1 = \{ \\vec{a}, \\vec{b}' \} $''').move_to(3*DOWN + 3.5*RIGHT)
        for i in range(4,6):
        ...
        # Texto para mostrar la definición de b'
        Textobprima = TextMobject('''$ \\vec{b}' := \\vec{b} - \\frac{\\langle \\vec{b}, \\vec{a} \\rangle}{||\\vec{a}||} \\hat{a} $''').move_to(3*DOWN)
        for i in range(0,3):
            Textobprima[0][i].set_color(VERDE)
        for i in (5,6,9,10):
            Textobprima[0][i].set_color(ROJO)
        for i in (12,13,18,19,22,23):
            Textobprima[0][i].set_color(AZUL)
        Textobprima.bg = SurroundingRectangle(Textobprima, color = WHITE, fill_color = BLACK, fill_opacity = 1)

        # Textos para los generados y sus rectángulos.
        Text9 = TextMobject('''$ \\langle I \\rangle $''').move_to(1.5*DOWN + 3.5*LEFT).set_color(MAGENTA_CLARO)
        Text9.bg = SurroundingRectangle(Text9, color = WHITE, fill_color = BLACK, fill_opacity = 1)
        Text9.group = VGroup(Text9.bg,Text9)
        Text9_1 = TextMobject('''$ \\langle \\Gamma_1 \\rangle = \\langle I \\rangle $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text9_1[0][0:4].set_color(TEAL_A)
        Text9_1[0][5:8].set_color(MAGENTA_CLARO)
        ...
        Text9_2 = TextMobject('''$ \\langle \\Gamma_1 \\rangle = \\langle I \\rangle = \\langle \\Gamma_2 \\rangle $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text9_2[0][0:4].set_color(TEAL_A)
        Text9_2[0][5:8].set_color(MAGENTA_CLARO)
        ...
        Text9_3 = TextMobject('''$ \\langle N \\rangle = \\langle I \\rangle $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text9_3[0][0:3].set_color(AZUL_CLARO)
        Text9_3[0][4:7].set_color(MAGENTA_CLARO)
        ...
        Text10 = TextMobject('''$ \\vec{u} + \\vec{v} $''').move_to(UP+3.5*LEFT)
        Text10_1 = TextMobject('''$ c \\vec{u} $''').move_to(3.5*LEFT)
        Text10_2 = TextMobject('''$ \\langle \\vec{u} , \\vec{v} \\rangle $''').move_to(DOWN+3.5*LEFT)
        ...
        Text_B = TextMobject('''$\\vec{b} = (5,2)$''').move_to(3*DOWN + 3.5*LEFT)
        ...
        Text14 = TextMobject('''$ \\{ \\vec{a} + c_2 \\vec{b} : c_2 \\in \\mathbb{R} \\} $''').move_to(1.5*DOWN + 3.5*LEFT)
        ...
        Text14_2 = TextMobject('''$ \\{ c_1 \\vec{a} + c_2 \\vec{b} : c_1, c_2 \\in \\mathbb{R} \\} $''').move_to(1.5*DOWN + 3.5*LEFT)
        ...
        Text14_3 = TextMobject('''$ \\{ c_1 \\vec{a} + c_2 \\vec{b} : c_1, c_2 \\in \\mathbb{R} \\} = \\langle I \\rangle $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text14_3[0][1:10].set_color(MAGENTA_CLARO)
        Text14_3[0][-3:None].set_color(MAGENTA_CLARO)
        ...
        Text15_1 = TextMobject('''$ \\vec{v} \\neq \\vec{0}, \\hat{v} := \\frac{\\vec{v}}{\\norm{\\vec{v}}} $''').move_to(0.5*UP + 3.5*LEFT)
        Text15_2 = TextMobject('''$ \\Rightarrow ||\\hat{v}|| = 1 $''').move_to(0.5*DOWN + 3.5*LEFT)
        Text15_3 = TextMobject('''$ \\Rightarrow \\frac{\\langle \\vec{u}, \\hat{v} \\rangle}{||\\hat{v}||} \\hat{v} = \\langle \\vec{u}, \\hat{v} \\rangle \\hat{v} $''').move_to(1.5*DOWN + 3.5*LEFT)
        Text15bg = SurroundingRectangle(VGroup(Text15_1,Text15_2,Text15_3),color=WHITE,fill_color=BLACK,fill_opacity=1)
        Text15group = VGroup(Text15bg,Text15_1,Text15_2,Text15_3)
        ...
        Text5_1 = TextMobject('''$ \\frac{ \\langle \\vec{b} , \\vec{a} \\rangle} { \\norm{ \\vec{a}} } \\hat{a} $''').set_color(AMARILLO).move_to(VecP_2.get_end()+0.5*UP)
        Text5_2 = TextMobject('''$ - \\frac{ \\langle \\vec{b} , \\vec{a} \\rangle} { \\norm{ \\vec{a}} } \\hat{a} $''').set_color(AMARILLO).move_to(VecPC_1.get_end()+0.9*RIGHT)
        ...
        # Ejes para mostrar independencia lineal de a y b
        ...
        # Ejes para mostrar independencia lineal de a y b'
        Eje3 = DashedLine((0-5*a_1, 0-5*a_2, 0),(5*a_1,5*a_2,0), color = MAGENTA, buff = 0)
        Eje4 = DashedLine((0-5*(b_1-p1_1), 0-5*(b_2-p2_1), 0),(5*(b_1-p1_1),5*(b_2-p2_1),0), color = MAGENTA, buff = 0)
        Ejes2 = VGroup(Eje3,Eje4)
        ...
        def gen1(Vec1,Vec2,Lab1,Lab2):
            ...
            Num_Lin_1 = NumberLine(x_min=-9,x_max=9,unit_size=3/18).rotate(np.pi/2)
            Num_Lin_1.move_to(2*DOWN + 3*RIGHT)
            # Segunda línea numérica
            Num_Lin_2 = NumberLine(x_min=-9,x_max=9,unit_size=3/18).rotate(np.pi/2)
            Num_Lin_2.move_to(2*DOWN + 1*RIGHT)
            # Paréntesis para conjunto abierto.
            ParSup1 = TextMobject(")").move_to(Num_Lin_1.get_end()+0.04*DOWN).scale(1).rotate(np.pi/2)
            ParInf1 = TextMobject(")").move_to(Num_Lin_1.get_start()+0.04*UP).scale(1).rotate(-np.pi/2)
            ParSup2 = TextMobject(")").move_to(Num_Lin_2.get_end()+0.04*DOWN).scale(1).rotate(np.pi/2)
            ParInf2 = TextMobject(")").move_to(Num_Lin_2.get_start()+0.04*UP).scale(1).rotate(-np.pi/2)
            # Símbolos de infinito
            Inf_1 = TextMobject("$ \\infty $").move_to(Num_Lin_1.get_end()+0.25*UP).scale(0.6)
            MInf_1 = TextMobject("$ - \\infty $").move_to(Num_Lin_1.get_start()+0.25*DOWN).scale(0.6)
            Inf_2 = TextMobject("$ \\infty $").move_to(Num_Lin_2.get_end()+0.25*UP).scale(0.6)
            MInf_2 = TextMobject("$ - \\infty $").move_to(Num_Lin_2.get_start()+0.25*DOWN).scale(0.6)
            ...
            Coef_1 = (TexMobject("c_2")).next_to(FLECHA_2.get_end(),RIGHT)
            # Valores para segunda recta numérica. 
            Coef_2 = (TexMobject("c_1")).next_to(FLECHA_1.get_end(),RIGHT)
            ...
            def upd_for_LINEA_1(obj):
                ...
                if t > 0:
                    if Num_Lin_1.number_to_point(t)[1] > obj.get_end()[1]:
                        new_LINEA = Line(obj.get_start(),Num_Lin_1.number_to_point(t),color=ROJO,width=15, stroke_width=15)
                    else:
                        return None
                elif t < 0:
                    if Num_Lin_1.number_to_point(t)[1] < obj.get_start()[1]:
                        new_LINEA = Line(Num_Lin_1.number_to_point(t),obj.get_end(),color=ROJO,width=15, stroke_width=15)
                    else:
                        return None
                elif t == 0:
                    return None
            ...
            def upd_for_LINEA_2(obj):
                ...
                if t > 0:
                    if Num_Lin_2.number_to_point(t)[1] > obj.get_end()[1]:
                        new_LINEA = Line(obj.get_start(),Num_Lin_2.number_to_point(t),color=AZUL,width=9, stroke_width=9)
                    else:
                        return None
                elif t < 0:
                    if Num_Lin_2.number_to_point(t)[1] < obj.get_start()[1]:
                        new_LINEA = Line(Num_Lin_2.number_to_point(t),obj.get_end(),color=AZUL,width=9, stroke_width=9)
                    else:
                        return None
                elif t == 0:
                    return None
            ...
            self.play(ShowCreation(Num_Lin_1),Write(ParSup1),Write(ParInf1),Write(Inf_1),Write(MInf_1),ShowCreation(LINEA_1),ShowCreation(FLECHA_1),ShowCreation(Coef_1),Write(Text14.group))
            self.add_foreground_mobjects(Text14.group)
            self.play(vt1.set_value,9,run_time=1.3,rate_func=linear)
            Linea1.remove_updater(upd_for_linea)
            self.play(vt1.set_value,1)
            self.play(vt1.set_value,-9,run_time=1.3,rate_func=linear)
            ...
            self.play(ShowCreation(Num_Lin_2),Write(ParSup2),Write(ParInf2),Write(Inf_2),Write(MInf_2),ShowCreation(LINEA_2),ShowCreation(FLECHA_2),ShowCreation(Coef_2),ReplacementTransform(Text14.group,Text14_2.group))
            ...
            self.play(ReplacementTransform(Text14_2,Text14_3),ReplacementTransform(Text14_2.bg,Text14_3.bg))
            self.remove_foreground_mobjects(Text14_2)
            self.add_foreground_mobject(Text14_3.group)
            self.wait(3)
        ...
        def gen2(Vec1,Vec2,Lab1,Lab2):
            ...
            self.play(FadeOut(VGroup(Plano1,Plano2)),FadeOut(VGroup(Text9_2.group)),FadeOut(VGroup(VecRCL,Punto)))
            self.play(Write(VGroup(Lab1,Lab2)))
        ...
        def gen3(Vec1,Vec2,Lab1,Lab2):
            ...
            self.play(FadeOut(VGroup(Plano1,Plano2)),FadeOut(Text9_1.group),FadeOut(VGroup(VecRCL,Punto)))
            self.play(Write(VGroup(Lab1,Lab2)))
        ...
        def gen4(Vec1,Vec2,Lab1,Lab2):
            ...
            self.play(FadeOut(VGroup(Plano1,Plano2)),FadeOut(Text9_3.group),FadeOut(VGroup(VecRCL,Punto)))
        ...
        self.wait(0.5)
        self.play(Write(Cto.group),run_time=2)
        ...
        #Corte del primer párrafo

        self.wait(4)
        self.play(Write(Text1.group), run_time=2)
        self.wait(1)
        ...
        self.play(ShowCreation(VecP),ReplacementTransform(Text1.bg,Text2.bg), run_time = 2)
        self.remove_foreground_mobject(Text1)
        self.play(ReplacementTransform(Text1_1,Text2_1),Write(Text2_2),ReplacementTransform(Text1[0][-2],Text1c[0][-2]), run_time = 2)
        self.wait(0.5)
        ...
        ##Corte del segundo párrafo

        self.wait(6)
        self.play(FadeOut(VecP), FadeOut(Tsilo.group), FadeOut(Text5.bg),ReplacementTransform(Text5,Text5_1))
        self.wait(0.65)
        self.play(Write(Text6.group),ReplacementTransform(Text6,Text6_1))
        self.wait(0.65)
        self.play(ReplacementTransform(VecP_2,VecPC_1),ReplacementTransform(Text5_1,Text5_2))
        self.play(ShowCreation(VecR_1))
        self.play(ShowCreation(VecRLab_1))
        self.remove_foreground_mobject(VecB)
        self.play(FadeOut(VGroup(VecPC_1,Text5_2,VecB,VecBLab)))
        self.add_foreground_mobject(Text6_1)
        self.play(ReplacementTransform(Text6.bg,Text6_2.bg),ReplacementTransform(Text6_1,Text6_2))
        self.add_foreground_mobjects(Text6_2.bg,Text6_2)
        self.wait(9)
        gen3(VecA,VecR_1,VecALab,VecRLab_1)
        self.play(ShowCreation(Textobprima.bg), run_time=0.5)
        self.play(ShowCreation(Textobprima), run_time=1.5)
        self.wait(3.5)
        self.add_foreground_mobjects(VecA,VecR_1, Textobprima.bg, Textobprima)
        self.play(ShowCreation(Ejes2))
        self.wait(0.5)
        self.play(FadeOut(Ejes2))
        self.wait(1.5)
        self.remove_foreground_mobjects(Textobprima.bg, Textobprima, Text5.group,Text6_2.bg,Text6_2)
        self.play(FadeOut(Textobprima.bg),FadeOut(Textobprima),FadeOut(VGroup(Text6_2.bg,Text6_2)))
        self.remove_foreground_mobjects(VecA,VecR_1)

        ##Corte del tercer párrafo

        self.wait(2.5)
        self.play(ReplacementTransform(VGroup(VecR_1,VecRLab_1),VGroup(VecB,VecBLab)))
        self.play(Write(CtoO.bg),Write(CtoO_1_1))
        self.bring_to_back(pared)
        self.bring_to_back(luz)
        self.play(ShowCreation(pared),FadeOut(VecALab),ShowCreation(luz))
        self.add_foreground_mobject(VecPnaranja)
        self.remove_foreground_mobject(VecA)
        self.play(ShowCreation(VecPnaranja),Write(Text13))
        self.play(FadeOut(luz),FadeOut(pared),Write(VecALab))
        ...
        self.play(FadeOut(VGroup(VecPC,VecA,VecALab)),FadeOut(Text13_2))
        self.play(ReplacementTransform(CtoO.bg,CtoO_2.bg),ReplacementTransform(CtoO_1_1,CtoO_2_1))
        self.wait(2)
        gen2(VecR,VecB,VecRLab,VecBLab)
        self.play(FadeOut(CtoO_2.bg),FadeOut(CtoO_2_1))
        ...
        self.wait(0.5)
        self.play(Write(Text15bg), run_time=0.5)
        ...
        self.wait(0.5)
        self.play(ReplacementTransform(VecBc,VecBNc),ReplacementTransform(VecBcLab,VecBNcLab))
        self.play(ReplacementTransform(CtoON,CtoON_1))
        self.wait(0.5)
        self.add_foreground_mobject(VecPc)
        self.play(ShowCreation(VecPc),Write(Text12_1))
        self.wait(0.5)
        ...
        self.wait(0,5)
        self.play(ReplacementTransform(VecRc,VecBPN),ReplacementTransform(VecRcLab,VecBPNLab))
        self.wait(0.5)
        self.add_foreground_mobject(CtoON_1)
        self.play(ReplacementTransform(CtoON.bg,CtoON_2.bg),ReplacementTransform(CtoON_1,CtoON_2))
